...
Babel::PortAudio::PortAudio() {
    ...
    this->_inputNumberChannels = 1;
    this->_outputNumberChannels = 1;
}
...
void Babel::PortAudio::openStream() {
    ...
    err = Pa_OpenStream(&this->_stream, &inputParameters, &outputParameters, this->_samplerate, this->_framesPerBuffer,
