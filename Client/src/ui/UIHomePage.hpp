...
public:
    ...
    void retranslateUi(QMainWindow *babelHome) const {
        ...
        tab_handler->setTabText(tab_handler->indexOf(page_connection),
                                QCoreApplication::translate("babelHome", "Connection", nullptr));
        ...
        tab_handler->setTabText(tab_handler->indexOf(page_login),
                                QCoreApplication::translate("babelHome", "Login", nullptr));
        ...
        tab_handler->setTabText(tab_handler->indexOf(page_server),
                                QCoreApplication::translate("babelHome", "Server", nullptr));
        ...
        tab_handler->setTabText(tab_handler->indexOf(page_call),
                                QCoreApplication::translate("babelHome", "Call", nullptr));
    } // retranslateUi
